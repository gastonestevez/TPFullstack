...
<html lang="en" dir="ltr">
    ...
    <nav class="navbar navbar-template navbar-expand-lg navbar-light bg-light justify-content-center ">
      ...
      <div class="collapse navbar-collapse order-3 order-lg-2" id="collapsibleNavbar">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#"><i class="fas fa-sign-in-alt carrito-nav"></i>Login</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#"><i class="fas fa-user-plus carrito-nav"></i>Registrarse</a>
          </li> 
        </ul>
      </div>
    </nav>
  ...
  <main class="py-4">
      <div class="card mx-auto border border-dark rounded " style="width: 18rem;">
          ...
          <div class="card-body ">
            ...
            <a href="#" class="btn btn-primary d-block mx-auto">¡Empecemos!</a>
          </div>
        </div>
  </main>
