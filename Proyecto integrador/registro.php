  ...
  <div class="registro">
      ...
      <div class="campos">
        <form class="registracion" action="index.html" method="post">
              ...
              <h5>Apellido</h5>
              <input id="apellido" type="text" name="apellido" value="" placeholder="Ingresa tu Apellido"><br><br>
              <h5>E-mail</h5>
              <input id="mail" type="mail" name="mail" value="" placeholder="Ingresa tu e-mail"><br><br>
              <h5>Fecha de nacimiento</h5>
              <input id="fechanacimiento" type="date" name="fechanacimiento" value="" ><br><br>
              <h5>Provincia</h5>
