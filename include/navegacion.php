      ...
      <div class="collapse navbar-collapse order-3 order-lg-2" id="collapsibleNavbar">
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="http://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-tshirt carrito-nav"></i>COLECCION</a>
            ...
            <li class="nav-item">
              <a class="nav-link" href="index.php"><i class="fas fa-percentage"></i></i> SALE</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="index.php"><i class="fas fa-envelope"></i></i> CONTACTO</a>
            </li>
